                ...
                <div className="bg-logic-dark border border-white/10 rounded-lg p-8 h-full">
                  ...
                  <div className="mt-12">
                    ...
                    <div className="flex space-x-4">
                      ...
                      <a href="https://www.instagram.com/_dev.solutions_/?utm_source=ig_web_button_share_sheet" className="bg-white/5 hover:bg-white/10 p-3 rounded-full transition-colors">
                        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      ...
                      <a href="https://www.linkedin.com/company/dev-solutions-lpu/" className="bg-white/5 hover:bg-white/10 p-3 rounded-full transition-colors">
                        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
