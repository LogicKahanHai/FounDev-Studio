...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen min-w-full mx-auto bg-logic-dark text-white">
      <Navbar />
      ...
      <main>
        ...
        <div className="py-16 bg-logic-dark-light">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-1 gap-8 md:gap-0 lg:grid-cols-2 xl:grid-cols-6">
              {/* Contact Information */}
              <div className="md:col-span-1 lg:col-span-2 xl:col-span-3 flex justify-center w-full md:mb-8 mb-0">
                <div className="bg-logic-dark border border-white/10 rounded-lg p-8 h-full w-fit">
                  ...
                  <div className="mt-12">
                    ...
                    <div className="flex space-x-4">
                      ...
                      <a href="https://www.instagram.com/foundevstudio/" className="bg-white/5 hover:bg-white/10 p-3 rounded-full transition-colors">
                        <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      ...
                      <a href="https://www.linkedin.com/company/foundevstudio/" className="bg-white/5 hover:bg-white/10 p-4 rounded-full transition-colors">
                        <svg className="h-4 w-4 translate-x-[0.2] -translate-y-[0.2]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="md:col-span-1 lg:col-span-2 xl:col-span-3">
                <div className="bg-logic-dark border border-white/10 rounded-lg p-8">
                  ...
                  <form action="https://formsubmit.co/anubhavjaiswal1803@gmail.com" method="POST" onSubmit={handleSubmit} className="space-y-6">
                    {/* FormSubmit configuration fields */}
                    <input type="hidden" name="_subject" value="New Project Inquiry from FounDev Studio" />
