        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex mt-6 space-x-4">
              ...
              <a href="https://www.instagram.com/foundevstudio/?utm_source=ig_web_button_share_sheet" className="text-logic-gray-light hover:text-logic-blue transition-colors">
