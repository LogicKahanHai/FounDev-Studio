      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member) => (
            ...
            >
              {/* <div className="absolute inset-0 bg-gradient-to-t from-logic-dark/80 to-transparent opacity-0 group-hover:opacity-70 transition-opacity duration-300 pointer-events-none"></div> */}
              <div className="flex flex-col items-center">
                ...
                <div className="mt-4 flex space-x-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  {member.social.github &&
                    <a href={member.social.github} target="_blank" className="text-logic-gray-light hover:text-logic-blue transition-colors">
                  ...
                  {member.social.linkedin &&
                    <a href={member.social.linkedin} target="_blank" className="text-logic-gray-light hover:text-logic-blue transition-colors">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
