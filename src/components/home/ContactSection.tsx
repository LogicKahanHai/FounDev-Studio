              ...
              <div className="p-6 md:p-8 border-b md:border-b-0 md:border-r border-white/10">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href="https://www.instagram.com/_dev.solutions_/?utm_source=ig_web_button_share_sheet" className="bg-white/5 hover:bg-white/10 p-2 rounded transition-colors">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <a href="https://www.linkedin.com/company/dev-solutions-lpu/" className="bg-white/5 hover:bg-white/10 p-2 rounded transition-colors">
                      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
